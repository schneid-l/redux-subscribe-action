...
var _unsubscribeAction = function (listenerContainer, filterAction) {
    var filteredListenerContainer = listenerContainer.filter(function (_a) {
...
exports.unsubscribeActionBefore = function (action) {
    _unsubscribeAction(_actionsSubscribedBefore, action);
};
exports.unsubscribeActionAfter = function (action) {
    _unsubscribeAction(_actionsSubscribedAfter, action);
};
exports.unsubscribeActionAll = function (action) {
